...
HD_PWD='C:/Users/youssefibrahim/Desktop/final project 2/final project 2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_final.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_final.tcl -notrace
