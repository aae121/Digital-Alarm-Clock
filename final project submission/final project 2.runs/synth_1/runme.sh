...
HD_PWD='C:/Users/youssefibrahim/Desktop/final project 2/final project 2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_final.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_final.tcl
